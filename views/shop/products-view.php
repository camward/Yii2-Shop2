<div class="col-4">
    ...
    <p><?=$products[0]->price?> rub. <label>Кол-во: </label> <input type="text" value="1" id="qty" /></p>
    <p><a href="<?= \yii\helpers\Url::to(['cart/add', 'id' => $products[0]->id])?>" data-id="<?= $products[0]->id?>" class="link add-to-cart">Add to cart</a></p>
</div>
