<div class="col-4">
    ...
    <p><label style="float: left;margin-top: 8px;margin-right: 10px;">Кол-во: </label> <input class="form-control" style="width: 60px;" type="text" value="1" id="qty" /><br /></p>
    <p style="float: right;margin-top: -45px;"><?=$products[0]->price?> rub. &nbsp; <a href="<?= \yii\helpers\Url::to(['cart/add', 'id' => $products[0]->id])?>" data-id="<?= $products[0]->id?>" class="link add-to-cart">Add to cart</a></p>
</div>
